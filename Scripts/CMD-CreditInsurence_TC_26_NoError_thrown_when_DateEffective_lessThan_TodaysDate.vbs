...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		externaRefVal = "CreditInsu05"&lcase(countryCode) & Right(topLevelERP,6)
		...
		searchreplaceString = "EntityTypeId-14;AccountNumber-" & topLevelERP & ";ExternalReference-" & externaRefVal &";CreditLimit-19000"
		...
		mypredISData = basicPreCreditInsurenceAPIData(jsonFPath,"GFN_SHELL_SPRINTQA_PH_OLTP","A - Low Risk",-4)
