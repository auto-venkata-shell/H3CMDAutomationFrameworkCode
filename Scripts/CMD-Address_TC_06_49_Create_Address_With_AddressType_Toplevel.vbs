...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		externaRefVal = "address01"&lcase(countryCode) & Right(topLevelERP,4)
		
		'*********** Generic Code for all scripts ****************
		Addressl1val= "Automation Test Estate" & Right(topLevelERP,4)
		Telephoneval  =  "+333333333" & Right(topLevelERP,4)
		...
		'********************** Scenario specific variables and business functions *********************
		searchreplaceString = "EntityTypeId-4;IsActive-true;AccountNumber-" & topLevelERP & ";"& "AddressTypeId-[2,3,4];ExternalReference-" & externaRefVal &";AddressLine1-" & Addressl1val &";Telephone-" & Telephoneval
		...
		Else
			...
			Call validateAddressLines(jsonFPath,addresscustid,externaRefVal,"2,3,4","insertion")
			topnewAddressref = externaRefVal
			...
			Call verifyAddressTypecheckFromUI(True)
		End If
	End If
next