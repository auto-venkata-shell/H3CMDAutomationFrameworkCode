...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		externaRefVal = "Bank01"&lcase(countryCode) & Right(topLevelERP,6)
		...
		'********************** Scenario specific variables and business functions *********************
		searchreplaceString = "EntityTypeId$5;DateTerminated$" & myDateTerminated &";AccountNumber$" & topLevelERP & ";"& "ExternalReference$" & externaRefVal & ";"
