...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		externaRefVal = "InvoiceRef01"&lcase(countryCode) & Right(subLevelERP,6)
		...
		searchreplaceString = "EntityTypeId$8;AccountNumber$" & subLevelERP & ";ExternalReference$" & externaRefVal & ";ColcoCode$" & db_ColcoCode  &";InvoiceReference$SUBINVOICEREFTEXT;DateEffective$" & myDateEffective & ";DateTerminated$"& myDateTerminated
