...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		searchreplaceString = "EntityTypeId-15;AccountNumber-" & topLevelERP & ";ExternalReference-" & externaRefVal &";CreditSystemCustomerNumber-NEWTEST"& Right(topLevelERP,6)
		...
		mypredISData = basicPreCreditDataAPIData(jsonFPath,"GFN_SHELL_SPRINTQA_PH_OLTP","B - Medium")
		...
		Else
			...
			Call validatePostCreditDataRecords(jsonFPath,addresscustid,"update")
