...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		outputfilepathval = "Cardorderoutput.txt"
		...
		'********************** Scenario specific variables and business functions *********************
		searchreplaceString = "ColCoID-" & custColcoval &";CustomerID-"& custCardNo &";CardCategoryID-" & cardapi_data("CardCatIDval") &";PINTypeID-"& cardapi_data("PinTypeIDval") &";PINAdviceType-"& cardapi_data("PinAdviceTypeidval") &";CardTypeID-"& cardTypeval &";TokenTypeID-"& tokentypeval &";SaveForPINReminder-false"
		
		Call searchandReplaceMultipleString(jsonFPath, searchreplaceString)
		headers = getapiConfigInfoFromCSV(Apconfigpath)
		Append_TestHTML StepCounter,"Customer Headers", headers ,"PASSED"
		Append_TestHTML StepCounter,"request URL", apiurl ,"PASSED"
