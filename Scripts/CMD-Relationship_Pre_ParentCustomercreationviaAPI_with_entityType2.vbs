...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		'topGPLevelERP = "PH01891003"
		If topGPLevelERP = Empty Then
		...
		Else
			...
			'********************** Scenario specific variables and business functions *********************
			searchreplaceString = "EntityTypeId-2;AccountNumber-" & newERPCustNo & ";"& "CustomerERP-" & newERPCustNo & ";"& "TopLevelCustomerNumber-" & topGPLevelERP & ";"& "ParentCustomerNumber-" & topGPLevelERP & ";"& "RegistrationNumber-Reg" & newERPCustNo & ";"& "VATRegNumber-Reg" & newERPCustNo
