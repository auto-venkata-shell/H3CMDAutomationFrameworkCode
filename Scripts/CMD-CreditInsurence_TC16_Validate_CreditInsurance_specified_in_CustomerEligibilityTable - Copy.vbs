...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		externaRefVal = "CreditInsu03"&lcase(countryCode) & Right(topLevelERP,6)
		...
		searchreplaceString = "EntityTypeId-14;AccountNumber-" & topLevelERP & ";ExternalReference-" & externaRefVal &";CreditLimit-999999999999.999999"
		...
		Else
			...
			topnewCreditInsref2 = externaRefVal
