...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		externaRefVal = "contact02"&lcase(countryCode) & Right(topLevelERP,6)
		...
		'********************** Scenario specific variables and business functions *********************
		Append_TestHTML StepCounter, "Create Card delivery contact", "Create new Card delivery contact with Primary contact as false of"& topLevelERP & " new contact" & externaRefVal , "PASSED"
		searchreplaceString = "EntityTypeId-7;IsPrimaryContact-false;IsActive-true;EmailAddress-CardDelType@gmail.com;AccountNumber-" & topLevelERP & ";"& "ContactTypeId-[18];ExternalReference-" & externaRefVal & ";AddressId-" & topnewAddressref
		...
		Else
			...
			Call validateContactLines(jsonFPath,addresscustid,externaRefVal,"18","insertionupdate")
