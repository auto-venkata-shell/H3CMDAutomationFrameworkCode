...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		'********************** Scenario specific variables and business functions *********************
		searchreplaceString = "EntityTypeId-4;AccountNumber-" & topLevelERP & ";"& "AddressTypeId-[0];ExternalReference-" & externaRefVal &";AddressLine1-Automation Test Estate"  & ";IsActive-false"
		...
		Else
			...
			Call validateAddressLines(jsonFPath,addresscustid,externaRefVal,"0","insertion")
			...
			Call verifyAddressTypecheckFromUI(False)
			searchreplaceString = "EntityTypeId$4;IsActive$true"
