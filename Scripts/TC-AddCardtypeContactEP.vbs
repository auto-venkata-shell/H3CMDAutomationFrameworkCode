...
For iRowCount=1 to iTotalRows 
	...
	If strExecute = "Yes" Then
		...
		cust_data.add "semail", Get_Dictionary(ParamValDict,"sEmail" & "_" & iRowCount)
		cust_data.add "memail", Get_Dictionary(ParamValDict,"mEmail" & "_" & iRowCount)
		...
		Call AddCardTypeContactERP(cust_data)
