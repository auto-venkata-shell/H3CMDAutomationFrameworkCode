...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		externaRefVal = "Bank05"&lcase(countryCode) & Right(topLevelERP,6)
		...
		myDateEffective = nextdateDBFormt(Date()+120)
	
		Call basicPreConfigBankData(jsonFPath,"GFN_SHELL_SPRINTQA_PH_OLTP")
		'********************** Scenario specific variables and business functions *********************
		searchreplaceString = "EntityTypeId$5;DateEffective$" & myDateEffective &";AccountNumber$" & topLevelERP & ";"& "ExternalReference$" & externaRefVal & ";"
		...
		Else
			...
			externamultiRefVal = topnewBankref & "|" & externaRefVal
