...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		inputfilepathval = "CustomerCreditDatanull.txt"
		...
		searchreplaceString = "EntityTypeId-15;AccountNumber-" & topLevelERP & ";ExternalReference-" & externaRefVal &";CreditSystemCustomerNumber-null"
