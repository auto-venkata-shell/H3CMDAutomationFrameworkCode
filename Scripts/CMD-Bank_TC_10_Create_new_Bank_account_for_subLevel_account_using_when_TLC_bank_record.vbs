...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		externaRefVal = "subcontact02"&lcase(countryCode) & Right(subLevelERP,6)
		
		'*********** Generic Code for all scripts ****************
		
		myDateEffective = nextdateDBFormt(Date()+30)
		...
		'********************** Scenario specific variables and business functions *********************
		searchreplaceString = "EntityTypeId-5;AccountNumber-" & subLevelERP & ";"& "ExternalReference-" & externaRefVal & ";DateEffective$" & myDateEffective 
		...
		Else
			...
			externamultiRefVal = subnewContactref & "|" & externaRefVal
			Call validateBankLines(jsonFPath,addresscustid,externamultiRefVal,"new")
