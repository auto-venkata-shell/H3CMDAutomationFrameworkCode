...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		rcheck = invokeToUpdateMyvalueinJSONAPI(reqType, apiurl, asynctype, strType, strJson, headers,2,"false")
		...
		Else
			...
			Call validateMultipleExistingCardAccountDetails(jsonFPath,addresscustid,2)
