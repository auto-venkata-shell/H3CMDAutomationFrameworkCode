...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		rcheck = invokeToUpdateMyvalueinJSONAPI(reqType, apiurl, asynctype, strType, strJson, headers,1,"false")
		...
		Else
			...
			Call validateCardTypeAPIRecords(jsonFPath,addresscustid,1)
