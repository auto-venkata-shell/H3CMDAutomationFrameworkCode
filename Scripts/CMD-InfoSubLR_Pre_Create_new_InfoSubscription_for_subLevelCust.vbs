...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		externaRefVal = "InfoSubscr01"&lcase(countryCode) & Right(subLevelERP,6)
		
		'*********** Generic Code for all scripts ****************
		
	
		'********************** Scenario specific variables and business functions *********************
		Call validateCustomerandCustomerInfoSubscriptionEntry(subLevelERP,0)
		...
		Else
			...
			subnewInfoSubref1 = externaRefVal
