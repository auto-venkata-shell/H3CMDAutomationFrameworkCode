...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		'********************** Scenario specific variables and business functions *********************
		searchreplaceString = "EntityTypeId-1;StatusId-1;StatusChangeReasonId-null;PriceProfileId-null;BlockDate-null;FeeGroupId-null;AccountNumber-" & newERPCustNo & ";"& "CustomerERP-" & newERPCustNo & ";"& "TopLevelCustomerNumber-" & newERPCustNo & ";"& "RegistrationNumber-Reg" & newERPCustNo & ";"& "VATRegNumber-Reg" & newERPCustNo
		...
		Else
			...
			Call feeandPriceDefaultvaluesValidation(topLevelERP)
