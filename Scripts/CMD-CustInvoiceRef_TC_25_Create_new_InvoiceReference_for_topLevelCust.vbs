...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		externaRefVal = "InvoiceRef01"&lcase(countryCode) & Right(topLevelERP,6)
		...
		myDateEffective = nextdateDBFormt(Date()+3)
		...
		searchreplaceString = "EntityTypeId$8;AccountNumber$" & topLevelERP & ";ExternalReference$" & externaRefVal & ";ColcoCode$" & db_ColcoCode  &";InvoiceReference$FIRSTINVOICEREFTEXT;DateEffective$" & myDateEffective & ";DateTerminated$"& myDateTerminated
