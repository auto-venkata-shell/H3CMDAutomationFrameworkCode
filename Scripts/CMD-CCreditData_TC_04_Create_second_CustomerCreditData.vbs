...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		externaRefVal = "CCreditDatau02"&lcase(countryCode) & Right(topLevelERP,6)
		...
		searchreplaceString = "EntityTypeId-15;AccountNumber-" & topLevelERP & ";ExternalReference-" & externaRefVal &";CreditSystemCustomerNumber-TEST2"& Right(topLevelERP,6)
		...
		mypredISData = basicPreCreditDataAPIData(jsonFPath,"GFN_SHELL_SPRINTQA_PH_OLTP","C - High Risk")
		...
		Else
			...
			Call validatePostCreditDataRecords(jsonFPath,addresscustid,"second")
