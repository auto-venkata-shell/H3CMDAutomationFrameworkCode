...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		'********************** Scenario specific variables and business functions *********************
		searchreplaceString = "EntityTypeId-7;Forename-AutomationFName;MiddleName-TestMName;LastName-ScriptLName;IsPrimaryContact-true;AccountNumber-" & topLevelERP & ";"& "ContactTypeId-[0];ExternalReference-" & externaRefVal & ";AddressId-" & topnewAddressref
