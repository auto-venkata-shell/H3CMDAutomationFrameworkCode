...
For iRowCount = 1 to iTotalRows 
	...
	contactName = Get_Dictionary(ParamValDict,"contactName" & "_" & iRowCount)
	...
	address = "AddressNew" & randomNumber(100,999)
	...
	If strExecute = "Yes_"& countryName Then			
		...
		'Creation of Card group
		Call launchApplicationnewGFN()
		Call customerSearch1(customerERP_id)
		Call select_existingCardGroup("CARD GROUP TEST1","#1",cardDelPoint)		
