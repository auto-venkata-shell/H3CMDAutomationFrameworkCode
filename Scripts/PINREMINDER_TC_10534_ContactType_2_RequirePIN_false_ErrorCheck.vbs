...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		panCarddet = pinReminderPrerequestFalseData()
		...
		rcheck = invokeAPIError(reqType, apiurl, asynctype, strType, strJson, headers,stropJson)
		
		If rcheck <> Empty and instr(rcheck,"address")>0 Then
