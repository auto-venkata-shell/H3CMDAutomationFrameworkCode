...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		'subPLevelERP = "PH01891003"
		If subPLevelERP = Empty Then
		...
		Else
			...
			'********************** Scenario specific variables and business functions *********************
			searchreplaceString = "EntityTypeId-2;AccountNumber-" & newERPCustNo & ";"& "CustomerERP-" & newERPCustNo & ";"& "TopLevelCustomerNumber-" & subPLevelERP & ";"& "ParentCustomerNumber-" & subPLevelERP & ";"& "RegistrationNumber-Reg" & newERPCustNo & ";"& "VATRegNumber-Reg" & newERPCustNo
