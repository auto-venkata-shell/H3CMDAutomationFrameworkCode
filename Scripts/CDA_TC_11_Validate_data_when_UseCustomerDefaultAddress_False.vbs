...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		inputfilepathval = "CardAddressjsonfalse.txt"
		...
		searchreplaceString = "ColCoID-" & pcolcoid &";CustomerID-"& pcustomerID &";CardID-" & pcardID & ";Card_CountryID-" & pcountryID
		...
		If rcheck <> Empty Then
			...
			Call validatepostCADValues(10,false,13,false,true,"autoTest@gmail.com") 'First two CDStatu, Next two CPStatus, Next two New records
