...
For iRowCount=1 to iTotalRows 
	...
	'CardTypeName,TokenTypeval,EmbossingTypeval,MinCardLife,MinReissuePeriod,ExpiryPeriod,EmbossingName
		...
		Call performCardActions("CardsWebLink_ReprintPIN")
		Call reissueCardvalidation()
		cNum = cardPANNum
		...
		if cNum <>"" Then
			...
			if fileCRA <> "" Then
				Call validatenegativeFiledata(fileCRA,cNum,"txt")
				'Call validateDX501filedata(fileCRA,"txt",cNum,"Pin Option",5,2,"11")
			...
			if filePMA<> "" Then
				...
				Call validateDX501filedata(filePMA,"txt",cNum,"Pin Option",5,2,"11")
				Call validateDX501filedata(filePMA,"txt",cNum,"Option SPecific data",37,35," ")
			End If
