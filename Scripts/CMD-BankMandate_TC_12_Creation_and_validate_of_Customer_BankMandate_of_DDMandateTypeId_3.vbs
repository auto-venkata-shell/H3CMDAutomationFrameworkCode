...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		externaRefVal = "BankMandate05"&lcase(countryCode) & Right(topLevelERP,6)
		...
		'********************** Scenario specific variables and business functions *********************
		searchreplaceString = "EntityTypeId-9;DDMandateTypeId-3;DDActive-true;AccountNumber-" & topLevelERP & ";"& "ExternalReference-" & externaRefVal & ";BankAccountId-" & topnewBankrefB3
