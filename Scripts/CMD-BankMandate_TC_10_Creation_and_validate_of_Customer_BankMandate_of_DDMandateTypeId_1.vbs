...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		externaRefVal = "BankMandate04"&lcase(countryCode) & Right(topLevelERP,6)
		...
		'********************** Scenario specific variables and business functions *********************
		searchreplaceString = "EntityTypeId$9;DDEffectiveDate$"& myDateEffective &";DDMandateTypeId$1;DDActive$false;AccountNumber$" & topLevelERP & ";"& "ExternalReference$" & externaRefVal & ";BankAccountId$" & topnewBankrefB2
