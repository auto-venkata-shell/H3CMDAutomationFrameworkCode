...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		inputfilepathval = "InfoSubscription.txt"
		outputfilepathval = "InfoSubscriptionoutput.txt"
		'infosubdetnavCheck = true
		...
		externaRefVal = "InfoSubscr01"&lcase(countryCode) & Right(topLevelERP,6)
		
		'*********** Generic Code for all scripts ****************
		
	
		'********************** Scenario specific variables and business functions *********************
		Call validateCustomerandCustomerInfoSubscriptionEntry(topLevelERP,0)
		searchreplaceString = "EntityTypeId-6;AccountNumber-" & topLevelERP & ";ExternalReference-" & externaRefVal
		...
		mypredISData = basicPreConfigInfoSubscriptionData(jsonFPath,"GFN_SHELL_SPRINTQA_PH_OLTP")
		...
		Else
			...
			topnewInfoSubref1 = externaRefVal
