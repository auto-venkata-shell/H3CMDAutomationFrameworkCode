...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		searchreplaceString = "EntityTypeId-11;AccountNumber-" & topLevelERP & ";ExternalReference-" & externaRefVal &";InfoSubscriptionId-" & topnewInfoSubref1 & ";SubscriptionType-true"
		...
		Else
			...
			topnewInfoSubDetLRref1 = externaRefVal
