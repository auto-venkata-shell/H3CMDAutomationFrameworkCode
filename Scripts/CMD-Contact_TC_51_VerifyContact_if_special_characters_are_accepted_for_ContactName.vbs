...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		'********************** Scenario specific variables and business functions *********************
		searchreplaceString = "EntityTypeId-7;IsActive-true;AccountNumber-" & topLevelERP & ";"& "ContactTypeId-[14,19];ExternalReference-" & externaRefVal & ";AddressId-" & topnewAddressref
		...
		rcheck = invokeUpdateJSONAPI(reqType, apiurl, asynctype, strType, strJson, headers,stropJson)
		...
		Else
			...
			Call validateContactLines(jsonFPath,addresscustid,externaRefVal,"14,19","update")
