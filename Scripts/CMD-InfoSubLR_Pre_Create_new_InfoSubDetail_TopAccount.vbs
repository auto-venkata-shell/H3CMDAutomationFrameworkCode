...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		searchreplaceString = "EntityTypeId-10;AccountNumber-" & topLevelERP & ";ExternalReference-" & externaRefVal &";InfoSubscriptionId-" & topnewInfoSubref1 & ";ContactId-" & topnewContactref& ";IsPrimary-true;SuppressContact-true;IsActive-false"
