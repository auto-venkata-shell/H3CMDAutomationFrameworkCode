...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		inputfilepathval = "Contactnull.txt"
		...
		'********************** Scenario specific variables and business functions *********************
		Append_TestHTML StepCounter, "Prepare INPUT JSON with null passed in non mandate fields", "NULL value of all non-mandate fields of contact-"& externaRefVal & " and customer-" & topLevelERP, "PASSED"
		searchreplaceString = "EntityTypeId-7;Forename-null;MiddleName-null;IsActive-true;AccountNumber-" & topLevelERP & ";"& "ContactTypeId-[14,19];ExternalReference-" & externaRefVal & ";AddressId-" & topnewAddressref
		...
		Else
			...
			Call validateContactLines(jsonFPath,addresscustid,externaRefVal,"14,19","insertion")
			...
			'searchreplaceString = "Forename-AutomationFName;MiddleName-TestMName"
			'Call searchandReplaceMultipleStrings_in_JSON(jsonFPath, searchreplaceString)
		End If
	End If
next