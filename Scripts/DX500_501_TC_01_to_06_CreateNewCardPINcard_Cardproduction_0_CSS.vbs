...
For iRowCount=1 to iTotalRows 
	...
	'CardTypeName,TokenTypeval,EmbossingTypeval,MinCardLife,MinReissuePeriod,ExpiryPeriod,EmbossingName
		...
		Call verifysysVarcolcoandupdate("CardProductionSystem",0, "AwaitCardSecurityData",0)
		...
		if cNum <>"" Then
			...
			Call validateDX500CRAfiledata(fileCRA,ftype)
			...
			if filePMA<> "" Then
				...
				Call validateDX500PMAfiledata(filePMA,ftype)
