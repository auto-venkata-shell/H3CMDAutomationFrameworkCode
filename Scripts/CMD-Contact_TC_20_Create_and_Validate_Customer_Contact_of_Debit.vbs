...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		'********************** Scenario specific variables and business functions *********************
		Append_TestHTML StepCounter, "Change contact type id value", "Update another ContactTypeID of existing non primary contact-"& externaRefVal & " and customer-" & topLevelERP, "PASSED"
		searchreplaceString = "EntityTypeId-7;AccountNumber-" & topLevelERP & ";"& "ContactTypeId-[3];ExternalReference-" & externaRefVal & ";AddressId-" & topnewAddressref
		...
		Else
			...
			Call validateContactLines(jsonFPath,addresscustid,externaRefVal,"3","update")
