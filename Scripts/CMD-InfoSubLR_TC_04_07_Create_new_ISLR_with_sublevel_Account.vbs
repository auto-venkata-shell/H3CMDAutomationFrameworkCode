...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		externaRefVal = "InfoSubscLR01"&lcase(countryCode) & Right(subLevelERP,6)
		...
		searchreplaceString = "EntityTypeId-11;AccountNumber-" & subLevelERP & ";ExternalReference-" & externaRefVal &";InfoSubscriptionId-" & subnewInfoSubref1 & ";SubscriptionType-false"
		...
		mypredISData = basicPreConfigInfoSubscLRData(jsonFPath,"GFN_SHELL_SPRINTQA_PH_OLTP")
		...
		Else
			...
			subnewInfoSubDetLRref1 = externaRefVal
