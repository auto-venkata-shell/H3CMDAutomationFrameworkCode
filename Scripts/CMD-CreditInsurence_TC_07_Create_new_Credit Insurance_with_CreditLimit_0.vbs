...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		externaRefVal = "CreditInsu02"&lcase(countryCode) & Right(topLevelERP,6)
		...
		searchreplaceString = "EntityTypeId-14;AccountNumber-" & topLevelERP & ";ExternalReference-" & externaRefVal &";CreditLimit-0"
		...
		Else
			...
			topnewCreditInsref1 = externaRefVal
