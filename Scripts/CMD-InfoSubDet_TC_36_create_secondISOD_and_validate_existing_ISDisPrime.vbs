...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		externaRefVal = "InfoSubscDet02"&lcase(countryCode) & Right(topLevelERP,6)
		...
		searchreplaceString = "EntityTypeId-10;AccountNumber-" & topLevelERP & ";ExternalReference-" & externaRefVal &";InfoSubscriptionId-" & topnewInfoSubref1 & ";ContactId-" & topnewContactref& ";IsPrimary-true;SuppressContact-false;IsActive-true"
		...
		Else
			...
			Call validatemultipleISDIsPrimaryStatus(topnewInfoSubDetref2,externaRefVal,false,true)
			topnewInfoSubDetref3 = externaRefVal
