...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		inputfilepathval = "Cardorder_without_Address.txt"
		outputfilepathval = "Cardorder_without_Addressoutput.txt"
		...
		Call doRequirePINFlagAction(ColcoTokentypeval,1,0)
		...
		'********************** Scenario specific variables and business functions *********************
		searchreplaceString = "ColCoID-" & custColcoval &";CustomerID-"& custCardNo &";CardCategoryID-" & cardapi_data("CardCatIDval") &";PINTypeID-"& cardapi_data("PinTypeIDval") &";PINAdviceType-"& cardapi_data("PinAdviceTypeidval") &";CardTypeID-" & Colcocardtypeval &";TokenTypeID-" & ColcoTokentypeval &";EmbossingID-4" 
