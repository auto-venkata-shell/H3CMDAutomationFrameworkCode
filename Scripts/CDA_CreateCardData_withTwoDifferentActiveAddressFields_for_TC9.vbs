...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		'********************** Scenario specific variables and business functions *********************
		searchreplaceString = "ColCoID-" & custColcoval &";CustomerID-"& custCardNo &";CardCategoryID-" & cardapi_data("CardCatIDval") &";PINTypeID-"& cardapi_data("PinTypeIDval") &";PINAdviceType-"& cardapi_data("PinAdviceTypeidval")&";EmbossingID-2" &";CardTypeID-" & Colcocardtypeval &";TokenTypeID-" & ColcoTokentypeval & ";UseCardContactDetails-false"
