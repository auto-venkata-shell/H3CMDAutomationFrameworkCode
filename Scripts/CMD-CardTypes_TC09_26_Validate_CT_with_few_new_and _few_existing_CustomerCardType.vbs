...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		rcheck = invokeToUpdateMyvalueinJSONAPI(reqType, apiurl, asynctype, strType, strJson, headers,2,"true")
		...
		Else
			...
			Call validateMultipleCardTypeAPIRecords(jsonFPath,addresscustid,2)
