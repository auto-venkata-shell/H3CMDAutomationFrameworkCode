...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		inputfilepathval = "InfoSubscriptionLegislativeRegion.txt"
		outputfilepathval = "InfoSubscriptionLegislativeRegionOP.txt"
		...
		externaRefVal = "InfoSubscLR01"&lcase(countryCode) & Right(topLevelERP,6)
		...
		Call infoSubLRPreValidation()
		searchreplaceString = "EntityTypeId-11;AccountNumber-" & topLevelERP & ";ExternalReference-" & externaRefVal &";InfoSubscriptionId-" & topnewInfoSubref1 & ";SubscriptionType-false"
		...
		mypredISData = basicPreConfigInfoSubscLRUpdateData(jsonFPath,"GFN_SHELL_SPRINTQA_PH_OLTP",2)
		...
		Else
			...
			addresscustid = verifyPostAPIActiveDetails("LegislativeRegionId",transReqID)
			
			Call validateInfoSubLRDetails(jsonFPath,addresscustid,externaRefVal)
			topnewInfoSubDetref1 = externaRefVal
