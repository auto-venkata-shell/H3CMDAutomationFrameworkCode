...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		externaRefVal = "BankMandate03"&lcase(countryCode) & Right(topLevelERP,6)
		...
		'********************** Scenario specific variables and business functions *********************
		Append_TestHTML StepCounter,"Set Bank Mandate fields of B2-"& topnewBankrefB1, "**** Set DDMandateTypeId value and create M2 of B2***" ,"PASSED"
		searchreplaceString = "EntityTypeId-9;DDMandateTypeId-2;DDActive-false;AccountNumber-" & topLevelERP & ";"& "ExternalReference-" & externaRefVal & ";BankAccountId-" & topnewBankrefB1
		...
		Else
			...
			Append_TestHTML StepCounter,"Validate M2 of B2-"& topnewBankrefB1, "**** Validate M2 Fields data***" ,"PASSED"
