...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		externaRefVal = "address02"& lcase(countryCode) & Right(subLevelERP,4)
		...
		'********************** Scenario specific variables and business functions *********************
		searchreplaceString = "EntityTypeId-4;AccountNumber-" & subLevelERP & ";"& "AddressTypeId-[2,3,4];ExternalReference-" & externaRefVal
		...
		Else
			...
			subnewAddressref = externaRefVal
