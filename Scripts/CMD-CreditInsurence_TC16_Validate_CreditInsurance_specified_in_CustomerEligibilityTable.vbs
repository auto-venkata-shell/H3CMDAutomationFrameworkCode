...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		externaRefVal = "CreditInsu04"&lcase(countryCode) & Right(topLevelERP,6)
		...
		searchreplaceString = "EntityTypeId-14;AccountNumber-" & topLevelERP & ";ExternalReference-" & externaRefVal
		...
		mypredISData = updateCreditLimitFromCustomerEligibility(jsonFPath,topLevelERP,"GFN_SHELL_SPRINTQA_PH_OLTP","B - Medium",0)
		...
		Else
			...
			Call verifyPostAPIActiveErrorDetails("CreditRatingId",transReqID,externaRefVal)
