...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase("Yes") Then
		...
		headers = getapiConfigInfoFromCSVForErrorvalidation(Apconfigpath,"InvalidUName")
		...
		Else
			Call errorcodevalidation(strJson, "E0003", "Unauthorized" )
		End If
		
		headers = getapiConfigInfoFromCSVForErrorvalidation(Apconfigpath,"InvalidPwd")
		...
		headers = getapiConfigInfoFromCSVForErrorvalidation(Apconfigpath,"InvalidUNPW")
		...
		headers = getapiConfigInfoFromCSVForErrorvalidation(Apconfigpath,"EmptyUNPW")
		...
		If rcheck = Empty Then
			Append_TestHTML StepCounter, "Verify Response JSON ", "Success:" & rcheck , "FAILED"
		Else
			Call errorcodevalidation(rcheck, "E0003", "Unauthorized" )
		End If
