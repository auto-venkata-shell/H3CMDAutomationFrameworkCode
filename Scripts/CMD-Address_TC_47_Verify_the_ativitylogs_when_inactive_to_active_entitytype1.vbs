...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		'********************** Scenario specific variables and business functions *********************
		searchreplaceString = "EntityTypeId-4;AccountNumber-" & topLevelERP & ";"& "AddressTypeId-[2,3,4];ExternalReference-" & externaRefVal & ";IsActive-true"
		...
		Else
			...
			Call validateAddressLines(jsonFPath,addresscustid,externaRefVal,"2,3,4","active")
