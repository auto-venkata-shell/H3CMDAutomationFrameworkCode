...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		'********************** Scenario specific variables and business functions *********************
		Append_TestHTML StepCounter, "Create New Contact", "Preparing input Contact JSON for "& topLevelERP , "PASSED"
		searchreplaceString = "EntityTypeId-7;Forename-Automation;MiddleName-Test;LastName-Script;IsPrimaryContact-true;AccountNumber-" & topLevelERP & ";"& "ContactTypeId-[1];ExternalReference-" & externaRefVal & ";AddressId-" & topnewAddressref
		...
		Else
			...
			Call validateContactLines(jsonFPath,addresscustid,externaRefVal,"1","insertion")
