...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		'********************** Scenario specific variables and business functions *********************
		searchreplaceString = "EntityTypeId-4;AccountNumber-" & topLevelERP & ";"& "AddressTypeId-[0];ExternalReference-" & externaRefVal
		...
		Else
			...
			Call validateAddressLines(jsonFPath,addresscustid,externaRefVal,"0","deletion")
			...
			verifyAddressTypecheckFromUI(False)
		End If
	End If
next