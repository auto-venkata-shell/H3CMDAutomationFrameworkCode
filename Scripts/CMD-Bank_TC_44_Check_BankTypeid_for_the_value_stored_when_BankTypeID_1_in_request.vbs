...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		externaRefVal = "Bank02"&lcase(countryCode) & Right(topLevelERP,6)
		'msgbox externaRefVal
		...
		'********************** Scenario specific variables and business functions *********************
		searchreplaceString = "EntityTypeId$5;BankTypeId$1;AccountNumber$" & topLevelERP & ";"& "ExternalReference$" & externaRefVal & ";DateEffective$" & myDateEffective
