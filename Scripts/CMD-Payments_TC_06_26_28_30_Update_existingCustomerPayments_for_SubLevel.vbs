...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		externaRefVal = "CPayment01"&lcase(countryCode) & Right(subLevelERP,6)
		...
		searchreplaceString = "EntityTypeId-13;AccountNumber-" & subLevelERP & ";ExternalReference-" & externaRefVal &";InvoiceLevelPayDetail-false"
		...
		mypredISData = basicPreConfigPaymentsupdatetestAPIData(jsonFPath,"GFN_SHELL_SPRINTQA_PH_OLTP","30 days after Invoice","Incoming - Direct Debit",200000)
		...
		Else
			...
			Call validatePaymentRecordValueswithCDCActivity(jsonFPath,addresscustid,externaRefVal,"update")
			Call navigateActivityLogScreenforValidation("update")
