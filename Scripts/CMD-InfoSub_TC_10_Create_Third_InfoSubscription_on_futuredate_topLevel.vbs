...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		externaRefVal = "InfoSubscr03"&lcase(countryCode) & Right(topLevelERP,6)
		...
		mypredISData = basicPreConfigExistingInfoSubscriptionUpdateForNextRow(jsonFPath,"GFN_SHELL_SPRINTQA_PH_OLTP",2,15)
		...
		Else
			...
			topnewInfoSubref3 = externaRefVal
