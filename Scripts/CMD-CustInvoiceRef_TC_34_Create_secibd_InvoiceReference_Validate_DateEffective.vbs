...
For iRowCount=1 to iTotalRows 
	...
	If ucase(strExecute) = ucase(strExecutevalue) Then
		...
		externaRefVal = "InvoiceRef02"&lcase(countryCode) & Right(topLevelERP,6)
		...
		searchreplaceString = "EntityTypeId$8;AccountNumber$" & topLevelERP & ";ExternalReference$" & externaRefVal & ";ColcoCode$" & db_ColcoCode  &";InvoiceReference$SECONDNVOICEREFTEXT;DateEffective$" & myDateEffective & ";DateTerminated$"& myDateTerminated
		...
		Else
			...
			Call validateCustomerInvoiceRefDatescompare(jsonFPath,addresscustid,topinvoiceCRef1,externaRefVal)
			
			topinvoiceCRef2 = externaRefVal
